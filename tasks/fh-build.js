...
module.exports = function(grunt) {
  ...
  grunt.registerTask('fh-dist',
                     ...
                     ['fh:dist']);
  grunt.registerTask('fh-dist-no-bundle-deps',
                     'Create tarball in ./dist/ without node_modules directory',
                     ['fh:dist:no-bundle-deps']);
  grunt.registerTask('fh-dist-only-bundle-deps',
                     'Create tarball in ./dist/ with node_modules directory',
                     ['fh:dist:only-bundle-deps']);
